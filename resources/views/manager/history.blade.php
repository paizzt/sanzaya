    ...
    <div class="wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <!-- Jika Manager boleh buat pengajuan -->
        ...
        <div class="main-content">
            <header class="top-navbar">
                <div class="nav-left">
                    ...
                    <h5 class="fw-bold m-0 ms-3 d-none d-md-block">Riwayat Keputusan SPPD</h5>
                </div>
                <div class="nav-right">
            ...
            <main class="content-area">
                ...
                <h5 class="fw-bold mb-4" style="color: var(--text-dark);">Daftar Dokumen yang Pernah Anda Proses (L1)</h5>
                    ...
                    <table class="table table-borderless mb-0 align-middle">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%;">Catatan Anda</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($req->status == 'pending_l2')
                                        <span class="status-pill bg-info-light"><i class="fas fa-money-check"></i> Lolos L1 (Cek Finance)</span>
                                    @elseif($req->status == 'approved')
                                        <span class="status-pill bg-success-light"><i class="fas fa-check-circle"></i> Selesai (Dicairkan)</span>
                                    @elseif($req->status == 'rejected')
                                        <span class="status-pill bg-danger-light"><i class="fas fa-times-circle"></i> Anda Tolak</span>
                                    @else
                                        <span class="status-pill bg-warning-light"><i class="fas fa-history"></i> {{ $req->status }}</span>
                                    @endif
                                </td>
                                <td>
                                    @if($req->l1_note)
                                        <p class="mb-0 small text-muted fst-italic" style="line-height: 1.4;">"{{ $req->l1_note }}"</p>
                                    @else
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    ...
                                    <p class="small">Anda belum melakukan tindakan (ACC/Tolak) pada pengajuan SPPD manapun.</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
