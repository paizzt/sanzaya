                    ...
                    <div class="col-lg-5">
                        <div class="action-card">
                            @if($menungguAcc > 0)
                                ...
                                <p>Mohon segera meninjau dan memberikan persetujuan (ACC) pada pengajuan SPPD tim agar dapat segera diproses oleh divisi Finance (Keuangan).</p>
                                <a href="{{ route('approvals.index') ?? '#' }}" class="btn-light-custom">
                                    Tinjau Sekarang <i class="fas fa-arrow-right ms-2"></i>
                                </a>
                            @else
                                <h4>Semua Tuntas! 🎉</h4>
                                <p>Kerja bagus! Tidak ada pengajuan SPPD dari tim yang menunggu persetujuan Anda saat ini. Semua antrean L1 telah diproses.</p>
                                    ...
                                    <div class="item-left">
                                        ...
                                        <div>
                                            ...
                                            <p class="m-0 text-muted" style="font-size: 11px;">
                                                <i class="far fa-calendar-alt me-1"></i> Berangkat: {{ \Carbon\Carbon::parse($sppd->start_date)->format('d M Y') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        ...
                                        <p class="m-0 text-muted mt-1" style="font-size: 10px;">Masuk: {{ \Carbon\Carbon::parse($sppd->created_at)->diffForHumans() }}</p>
                                    </div>
                                </div>
                                @empty
                                <div class="text-center py-4 text-muted small">
                                    <i class="fas fa-check-circle fa-2x mb-2" style="color: #A7F3D0;"></i><br>
                                    Tidak ada antrean SPPD yang membutuhkan ACC.
                                </div>
                                @endforelse
                            </div>
                        </div>
