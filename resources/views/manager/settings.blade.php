                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-8">
                        <div class="settings-card h-100">
                            <h5 class="settings-title"><i class="far fa-user"></i> Informasi Profil Manajer</h5>
                            ...
                            <div class="avatar-upload">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">{{ Auth::user()->name ?? 'Manajer / HRD' }}</h6>
                                    <p class="text-muted small mb-2">{{ Auth::user()->email ?? 'manager@sanzaya.com' }}</p>
                            ...
                            <form id="profileForm" onsubmit="event.preventDefault(); saveProfile();">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="input-custom" value="{{ Auth::user()->division ?? 'Manajemen' }}" disabled>
                    ...
                    <div class="col-xl-4">
                        <div class="settings-card h-100">
                            ...
                            <p class="text-muted small mb-4">Pastikan Anda menggunakan kata sandi yang kuat dan rahasia untuk menjaga keamanan hak otorisasi Anda (L1).</p>
    ...
    <script>
        ...
        function savePassword() {
            ...
            Swal.fire({
                ...
                text: 'Kata sandi Manajer berhasil diperbarui. Silakan gunakan password baru pada login berikutnya.',
                confirmButtonColor: '#0A539B'
            }).then(() => {
                form.reset();
            });
