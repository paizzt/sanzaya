...
<head>
    ...
    <title>Pengaturan Akun Manajer - Satu Sanzaya</title>
...
<body class="bg-surface text-slate-800 font-sans antialiased overflow-hidden flex h-screen">
    ...
    @php
        ...
        // Logika Notifikasi khusus Manajer
    ...
    <aside id="sidebar" class="sidebar bg-white w-[280px] h-full border-r border-slate-200 flex flex-col transition-all-ease fixed lg:relative z-50 -translate-x-full lg:translate-x-0 shadow-2xl lg:shadow-none">
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar py-6 px-4 space-y-1">
            ...
            <a href="{{ route('manager.settings') ?? '#' }}" class="menu-item flex items-center px-4 py-3 rounded-xl bg-brand-50 text-brand-600 font-medium transition-all-ease">
        ...
        <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200/60 sticky top-0 z-30 flex items-center justify-between px-6 lg:px-10 transition-all-ease">
            ...
            <div class="flex items-center gap-4 nav-left">
                ...
                <div class="hidden md:block">
                    <h1 class="text-xl font-bold text-slate-800">Pengaturan Akun Manajer</h1>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white rounded-3xl border border-slate-200 shadow-soft p-6 sm:p-8 h-full">
                            <div class="flex items-center gap-3 mb-8 border-b border-slate-100 pb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 text-xs mt-0.5">Kelola identitas dan kontak profesional Anda.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
                                ...
                                <div class="text-center sm:text-left pt-2">
                                    <h5 class="text-lg font-bold text-slate-800 mb-1">{{ Auth::user()->name ?? 'Manajer / HRD' }}</h5>
                                    <p class="text-slate-500 text-sm mb-3">{{ Auth::user()->email ?? 'manager@sanzaya.com' }}</p>
                            ...
                            <form id="profileForm" onsubmit="event.preventDefault(); saveProfile();">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-100 text-slate-500 font-medium outline-none cursor-not-allowed" value="{{ Auth::user()->division ?? 'Manajemen' }}" disabled>
                    ...
                    <div class="xl:col-span-1">
                        <div class="bg-white rounded-3xl border border-slate-200 shadow-soft p-6 sm:p-8 h-full">
                            ...
                            <p class="text-slate-500 text-xs mb-6 leading-relaxed">Pastikan Anda menggunakan kata sandi yang kuat dan rahasia untuk menjaga keamanan hak otorisasi Anda (L1).</p>
    ...
    <script>
        ...
        function saveProfile() {
            Swal.fire({
                ...
                text: 'Perubahan data profil Manajer berhasil disimpan.',
        ...
        function savePassword() {
            ...
            Swal.fire({
                ...
                text: 'Kata sandi Anda berhasil diperbarui. Silakan gunakan password baru pada login berikutnya.',
                confirmButtonColor: '#3b82f6',
                customClass: {
                    popup: 'rounded-2xl',
                    confirmButton: 'rounded-xl px-6 py-2.5'
