...
<head>
    ...
    <title>Pengaturan Manajer - Satu Sanzaya</title>
    ...
    <style>
        ...
        .settings-card { background: #FFFFFF; border-radius: 12px; border: 1px solid var(--border-color); padding: 30px; margin-bottom: 25px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); }
        ...
        .form-control:focus { background-color: #FFFFFF; border-color: var(--primary-blue); box-shadow: 0 0 0 3px rgba(10, 83, 155, 0.1); }
...
<body>
        ...
        <div class="main-content">
            <header class="top-navbar">
                <div class="nav-left">
                    ...
                    <h5 class="mb-0 fw-bold ms-3 d-none d-md-block">Pengaturan Profil</h5>
                </div>
                <div class="nav-right">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="settings-card">
                                <h4 class="settings-title"><i class="far fa-user me-2"></i> Data Pribadi</h4>
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn-outline-custom">Ubah Foto</button>
                                    </div>
                                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="text-muted">Hubungi Admin jika ada perubahan divisi.</small>
                                    </div>
                                    <div class="col-12 mt-4 text-end">
                                        <button type="submit" class="btn-primary-custom">Simpan Perubahan Profil</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="settings-card">
                                ...
                                <p class="text-muted small mb-4">Kosongkan kolom di bawah ini jika Anda tidak ingin mengubah password saat ini.</p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmation" placeholder="Ketik ulang password baru">
                                </div>
                                
                                <button type="submit" class="btn-primary-custom w-100">Perbarui Keamanan</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        // Menampilkan Alert Jika Sukses Update
        @if(session('success'))
            Swal.fire({
                icon: 'success',
                title: 'Berhasil',
