                                ...
                                <div class="list-item">
                                    <div class="item-left">
                                        ...
                                        <div>
                                            ...
                                            <p class="m-0 text-muted" style="font-size: 11px;">{{ \Carbon\Carbon::parse($UC->start_date)->format('d M') }} - {{ \Carbon\Carbon::parse($UC->end_date)->format('d M Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        ...
                                        @endif
                                        <p class="m-0 text-muted mt-1" style="font-size: 10px;">Dikirim: {{ \Carbon\Carbon::parse($UC->created_at)->diffForHumans() }}</p>
                                    </div>
                                </div>
                                @empty
                                <div class="text-center py-4 text-muted small">
                                    <i class="fas fa-folder-open fa-2x mb-2" style="color: #CBD5E1;"></i><br>
                                    Anda belum memiliki riwayat pengajuan UC.
                                </div>
                                @endforelse
                            </div>
                        </div>
