...
<head>
    ...
    <style>
        ...
        * { 
        ...
        /* 💳 KARTU RESET PASSWORD & ANIMASI STAGGERED 💳 */
        .login-card {
        ...
        .input-group input {
            width: 100%; 
            padding: 16px 50px; /* Ruang untuk icon kiri dan kanan */
            font-size: 14px;
            font-weight: 500;
            color: var(--dark-gray);
...
<body>
    ...
    <main class="login-card">
        ...
        <p class="login-desc">Silakan masukkan password baru Anda untuk memulihkan akses ke akun.</p>
        ...
        <form action="#" method="POST" class="login-form" id="resetForm">
            ...
            <button type="submit" class="btn-login" id="btnSubmit">
                Simpan Password <i class="fas fa-save text-sm"></i>
            </button>
        </form>
    </main>

    <script>
        // Logika Toggle Ikon Mata (Lihat Password)
