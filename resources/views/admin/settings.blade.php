...
<head>
    ...
    <title>Pengaturan - Satu Sanzaya</title>
    ...
    <div class="wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="#" class="menu-item active"><i class="fas fa-gear menu-icon"></i><span class="menu-text">Settings</span></a></li>
            </ul>
        ...
        <div class="main-content">
            <header class="top-navbar">
                <div class="nav-left">
                    ...
                    <h5 class="mb-0 fw-bold ms-3">Pengaturan</h5>
                </div>
                <div class="nav-right">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="settings-card">
                            <h4 class="settings-title"><i class="far fa-user me-2"></i> Profil Pengguna</h4>
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Jabatan (Akses Sistem)</label>
                                        <input type="text" class="form-control" value="{{ strtoupper(Auth::user()->role ?? 'ADMIN') }}" disabled>
                                        <small class="text-muted">Hubungi administrator utama untuk mengubah hak akses.</small>
                                    </div>
